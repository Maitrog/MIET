...
namespace lab3.Strategy
{
    internal abstract class Strategy
    {
        ...
        protected internal static readonly Tuple<double, int, int>[] _tableCost = new Tuple<double, int, int>[21]
        {
        ...
        protected internal static readonly Dictionary<string, int> _table = new()
        {
            { "msk", 0 },
            { "mzh", 1 },
            { "zvn", 2 },
        ...
        protected internal static readonly string[] _points = new string[SIZE] { "msk_AP","msk_TS","msk_WH","mzh_TS",
            "mzh_WH","zvn_WH","NN_AP","NN_TS", "NN_WH","dzr_TS","dzr_WH",
            "vlg_AP","vlg_TS","vlg_WH","kam_TS","kam_WH" };
        protected internal static readonly int[,] _matrixDist = new int[SIZE, SIZE]
        {
